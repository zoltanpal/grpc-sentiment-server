...
texts = [
    ...
    (
        "Kontroversiel bodybuilder kunne købe reklamer for sin steroide-guide hos Instagram",
        "dan",
    ),
    (
        "Ny undersøgelse afslører fordelene ved en plantebaseret kost for hjertesundhed",
        "dan",
    ),
    (
        "Protester i Minnesota bryder ud efter ICE-officer dræber kvinde under razzia",
        "dan",
    ),
